...
class ScoreHander(xml.sax.ContentHandler):
    ...
    def characters(self, content):
        ...
        if self.current == "octave":
            ...
            self.note_list.append((self.current_note.pitch,self.current_note.octave))
        # if self.current =="string":
        #     string=int(content)
        #     self.current_note.set_string(string)
        # if self.current=="fret":
        #     fret=string(content)
        #     self.current_note.set_fret(fret)
        #     self.note_list.append((self.current_note.string,self.current_note.fret))
...
if __name__=="__main__":
    # with open("TheLittleSea.musicxml") as Song:
    #     mylist=parse_score(Song)
    mylist=parse_score('TheLittleSea.musicxml')
    print(mylist)